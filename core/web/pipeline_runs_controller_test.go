...
func setupPipelineRunsControllerTests(t *testing.T) (cltest.HTTPClientCleaner, int32, []int64, func()) {
	...
	_, fromAddress := cltest.MustAddRandomKeyToKeystore(t, app.Store)
	...
	"""
	`, cltest.NewAddress().Hex(), cltest.DefaultP2PPeerID, cltest.DefaultOCRKeyBundleID, fromAddress, mockHTTP.URL)), &ocrJobSpec)
	require.NoError(t, err)
